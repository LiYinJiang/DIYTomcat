...
public class JspUtil {
	...
	public static void main(String[] args) {
		try {
			Context context = new Context("/javaweb", "H:/Java_source_space/javaweb/web", null, true);
			File file = new File("H:/Java_source_space/javaweb/web/index.jsp");
	...
	public static void compileJsp(Context context, File file) throws JasperException {
		...
		String workPath = new File(Constant.FOLDER_WORK, subFolder).getAbsolutePath() + File.separator;

		String[] args = new String[] { "-webapp", context.getDocBase().toLowerCase(), "-d", workPath.toLowerCase(),
				"-compile", };
	...
	public static String getServletPath(String uri, String subFolder) {
		...
		File tempFile = FileUtil.file(Constant.FOLDER_WORK, subFolder, tempPath);
	...
	public static String getJspServletClassName(String uri, String subFolder) {
		File tempFile = FileUtil.file(Constant.FOLDER_WORK, subFolder);
